...
import com.rendox.routinetracker.core.ui.getLocale
import com.rendox.routinetracker.core.ui.theme.routineStatusColors
import com.rendox.routinetracker.feature.routine_stats.R
...
private fun CalendarMonthlyPaged(
    ...
    Column(modifier = modifier) {
        CalendarTitle(modifier = Modifier
            .fillMaxWidth()
            .padding(bottom = 8.dp),
...
fun RoutineStatusDay(
    ...
    val skippedBackground =
        if (includedInAStreak) MaterialTheme.routineStatusColors.skippedInStreak
    ...
    val backgroundColor: Color = when (routineStatus) {
    ...
    val strokeColor: Color = when (routineStatus) {
    ...
    Box(
        ...
        Surface(
            ...
            border = BorderStroke(2.dp, color = strokeColor)
        ) {
...
@Composable
private fun DaysOfWeekTitles(modifier: Modifier = Modifier, daysOfWeek: List<DayOfWeek>) {
    Row(
        modifier = modifier,
...
@Preview(
    showSystemUi = true, showBackground = true, backgroundColor = 0xFF1A1B1E,
    wallpaper = Wallpapers.NONE,
)
@Composable
private fun RoutineStatusCalendarPreview() {
    Box(modifier = Modifier.fillMaxSize()) {
        Card(
            modifier = Modifier
                .padding(16.dp)
